...
class DictionaryLearningMatchingPursuit(nn.Module):
    """Dictionary learning algorithm with Matching Pursuit.
  ...
  """
    ...
    def __init__(self, dim, num_atoms, commitment_cost, sparsity_level, epsilon=1e-10) -> None:
        super(DictionaryLearningMatchingPursuit, self).__init__()
        self.dim = dim
        self.num_atoms = num_atoms
