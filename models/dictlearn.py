...
class DictLearn(nn.Module):
    ...
    def forward(self, z_e):
        ...
        if self._gamma is None:
            ...
            self._gamma.data.copy_(nn.Parameter(self.update_gamma(z_e)))
        ...
        loss = e_latent_loss * self._commitment_cost + self._beta * F.mse_loss(self._dictionary @ encodings.detach(), z_e.detach())
